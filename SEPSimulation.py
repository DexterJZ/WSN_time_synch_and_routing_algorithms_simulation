...
if __name__ == '__main__':
	data1, data2 = simulateSEP(100, 0.05)
	data3, data4 = LEACHSimulationAd.simulateLEACH(100, 0.05)
	data5, data6 = LEACHSimulationNoAd.simulateLEACH(100, 0.05)

	pylab.figure(0)
	pylab.plot(data1, label = 'SEP')
	pylab.plot(data3, label = 'LEACH with Ad')
	pylab.plot(data5, label = 'LEACH without Ad')
	pylab.title('Simulation of SEP')
	...
	data4.append(0.0)
	data6.append(0.0)
	pylab.plot(data2, label = 'SEP')
	pylab.plot(data4, label = 'LEACH with Ad')
	pylab.plot(data6, label = 'LEACH without Ad')
	pylab.title('Simulation of SEP')
	pylab.xlabel('Time steps (rounds)')
	pylab.ylabel('Average Energy left')
	pylab.legend()
